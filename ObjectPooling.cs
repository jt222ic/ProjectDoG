...
public class ObjectPooling : MonoBehaviour {
    ...
    //{
    //    for (int i = ListofPooledObject.Count - 1; i > 0; i--)
    //    {
    //        GameObject objInList = ListofPooledObject[i];

    //        //if (ListofPooledObject[i].activeInHierarchy)
    //        //{
    //            Debug.Log("rensar");
    //            //Destroy(objInList.gameObject);
    //            Destroy(ListofPooledObject[i]);

    //        //}

    //    }
    //    ListofPooledObject = null;
